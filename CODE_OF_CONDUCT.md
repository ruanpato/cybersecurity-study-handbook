...
🌐 **English** · **Português** (below / abaixo)

> Adapted from the [Contributor Covenant](https://www.contributor-covenant.org), version 2.1.
> **Reporting / Como reportar:** open a private
> [GitHub Security Advisory](https://github.com/ruanpato/cybersecurity-study-handbook/security/advisories/new)
> or contact the maintainer through their GitHub profile (**@ruanpato**). All reports are handled
> confidentially. / Abra um *advisory* privado ou contate o mantenedor pelo perfil **@ruanpato**;
...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the community leaders responsible for enforcement using the reporting channel listed at the top of this document. All complaints will be reviewed and investigated promptly and fairly.
...
## Português — Código de Conduta de Colaboração
...
Ocorrências de comportamentos abusivos, de assédio ou que sejam inaceitáveis por qualquer outro motivo poderão ser reportadas para a liderança da comunidade, responsável pela aplicação, pelo canal de contato indicado no topo deste documento. Todas as reclamações serão revisadas e investigadas imediatamente e de maneira justa.
...
As Diretrizes de Impacto na Comunidade foram inspiradas pela [Aplicação do código de conduta Mozilla][Mozilla CoC].
